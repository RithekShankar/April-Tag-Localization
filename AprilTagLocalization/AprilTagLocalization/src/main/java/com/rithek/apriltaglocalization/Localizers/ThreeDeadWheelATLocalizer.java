...
public class ThreeDeadWheelATLocalizer extends AprilTagCorrectionLocalizer {
    ...
    public ThreeDeadWheelATLocalizer(HardwareMap hardwareMap,AprilTagReader aprilTagReader,double inPerTick){
        super(aprilTagReader);
    ...
    @Override
    public Twist2dDual<Time> updateMainLocalizer(){
